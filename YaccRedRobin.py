...
def p_cicloestatico(p):
    'cicloestatico : FOR ID smforprepare IN P_ABRE smaddParentesis expresion smRemoveParentesis smforinitialize GUIONBAJO smforstart smaddParentesis expresion smRemoveParentesis smforcondition P_CIERRA STEP valor smCheckPendingNegatives L_ABRE cuerpofuncion L_CIERRA smforend'
